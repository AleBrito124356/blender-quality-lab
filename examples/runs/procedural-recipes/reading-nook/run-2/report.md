...
1. **Key 'Large warm key' and fill 'Cool fill' are nearly equal on the visible subject (1.06:1); fine for catalogue shots, raise the key for more shape** For more shape, double 'Large warm key' or halve 'Cool fill'.
...
- 'Large warm key' (AREA, 900.0 W, light orange): key, lights 67.9% of the visible subject, about 2.0208 W/m2, partly blocked by 'Side wall', 'Chair seat' and 1 more.
- 'Cool fill' (AREA, 400.0 W, light blue): fill, lights 83.5% of the visible subject, about 1.9014 W/m2, partly blocked by 'Side table top', 'Chair seat' and 1 more.
- 'Edge separation' (AREA, 1000.0 W, light orange): accent, lights 27.1% of the visible subject, about 0.5656 W/m2, partly blocked by 'Floating shelf.002', 'Back wall' and 1 more.
...
- (info) Key 'Large warm key' and fill 'Cool fill' are nearly equal on the visible subject (1.06:1); fine for catalogue shots, raise the key for more shape.

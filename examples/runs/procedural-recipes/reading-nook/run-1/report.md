...
1. **Key 'Large warm key' and fill 'Cool fill' are nearly equal on the visible subject (1.05:1); fine for catalogue shots, raise the key for more shape** For more shape, double 'Large warm key' or halve 'Cool fill'.
...
- 'Large warm key' (AREA, 900.0 W, light orange): key, lights 66.4% of the visible subject, about 2.0122 W/m2, partly blocked by 'Side wall', 'Chair seat' and 1 more.
- 'Cool fill' (AREA, 400.0 W, light blue): fill, lights 83.0% of the visible subject, about 1.9082 W/m2, partly blocked by 'Side table top', 'Chair seat' and 1 more.
- 'Edge separation' (AREA, 1000.0 W, light orange): accent, lights 27.2% of the visible subject, about 0.5731 W/m2, partly blocked by 'Floating shelf.002', 'Back wall' and 1 more.
Key-to-fill ratio about 1.05:1.
...
- (info) Key 'Large warm key' and fill 'Cool fill' are nearly equal on the visible subject (1.05:1); fine for catalogue shots, raise the key for more shape.

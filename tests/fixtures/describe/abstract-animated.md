...
Frames 1-48 at 24.0 fps.
- 'Copper orbit 3': location keyed on frames [1.0, 48.0], travels 0.9945 (max speed 0.7792/s).
- 'Editorial camera': location keyed on frames [1.0, 48.0].
